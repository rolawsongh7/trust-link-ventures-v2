...
-- Ensure quote_requests has proper policies
...
CREATE POLICY "Admins can manage all quote requests" ON public.quote_requests FOR ALL USING (check_user_role(auth.uid(), 'admin'));
