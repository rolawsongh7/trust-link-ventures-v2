  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        /* Trust Link Gradients */
        'tl-gradient': 'var(--gradient-primary)',
        'tl-gradient-hero': 'var(--gradient-hero)',
        'tl-gradient-accent': 'var(--gradient-accent)',
      },
      boxShadow: {
        'xs': 'var(--shadow-xs)',
        'sm': 'var(--shadow-sm)',
