...
UPDATE public.user_roles SET role = 'sales_rep' WHERE role IN ('sales_rep', 'sales', 'rep');
UPDATE public.user_roles SET role = 'user' WHERE role NOT IN ('admin', 'sales_rep', 'sales', 'rep');
